...
function doc(bookingId: string, total = 250_000): InvoiceDocument {
  return {
    ...
    guests: 1,
    infants: 0,
    room_lines: [{ kind: "room", description: "H-101 — Double sharing", days: 1, rate: total, amount: total }],
    subtotal_rooms: total,
    meal_lines: [
      { meal: "breakfast", count: 0, rate: 8000, amount: 0 },
      { meal: "lunch", count: 0, rate: 12000, amount: 0 },
      { meal: "dinner", count: 0, rate: 10000, amount: 0 },
    ],
    subtotal_dining: 0,
    total,
    gst_percent: 0,

/**
 * The title block at the top of every portal page: a serif heading, the gold
 * rule from the guest house website, and a line on what the page is for.
  ...
  return (
    <div className="flex flex-wrap items-end justify-between gap-3">
      <div className="min-w-0">
        ...
        <div aria-hidden className="mt-2.5 mb-3 h-[3px] w-14 bg-gold" />
